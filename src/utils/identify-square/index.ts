...
/**
 * A function that indetifies and returns a current square of a given Suduku Grid at a row and column index.
 * @param input opject with a 9x9 Suduku Grid with a row index and column index
 * @returns
 */
